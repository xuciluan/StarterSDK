...
import zwzt.fangqiu.edu.com.zwzt.starter.TaskDispatcher;
import zwzt.fangqiu.edu.com.zwzt.starter.util.DispatcherExecutor;
...
public abstract class Task implements ITask {
    ...
    /**
     *
     * CPU 密集型的一定要切换到DispatcherExecuTask执行在哪个线程池，默认在IO的线程池；tor.getCPUExecutor();
     *
     * @return
     */
    @Override
